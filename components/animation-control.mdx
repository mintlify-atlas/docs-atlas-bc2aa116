...
import type { SparklesIconHandle } from 'lucide-animated';
...
```tsx
import { useRef, useEffect } from 'react';
import { HeartIcon, SparklesIcon } from 'lucide-animated';
import type { HeartIconHandle, SparklesIconHandle } from 'lucide-animated';
